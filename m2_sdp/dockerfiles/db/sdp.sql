...
INSERT INTO sdpid (sdpid, valid, type, country, state, locality, org, org_unit, alt_name, email, serial)
VALUES 
(1, 1, 'gateway', 'IN', 'A', 'A', 'A', 'A', 'A', 'A', 'A'),
(2, 1, 'controller', 'IN', 'A', 'A', 'A', 'A', 'A', 'A', 'A'),
(3, 1, 'client', 'IN', 'A', 'A', 'A', 'A', 'A', 'A', 'A');

-- b. service
INSERT INTO service (id, name, description)
VALUES 
(1, 'controller', 'controller service'),
(2, 'tcp', 'tcp service'),
(3, 'udp', 'udp service');

-- c. service_gateway - Mapping services to gateway protection
INSERT INTO service_gateway (id, service_id, gateway_sdpid, protocol, port, nat_ip, nat_port)
VALUES 
(1, 1, 1, 'tcp', 5000, '192.168.1.1', 5000), -- controller protected by gateway
(2, 2, 1, 'tcp', 4444, '192.168.1.2', 4444), -- tcp service protected by gateway
(3, 3, 1, 'udp', 5555, '192.168.1.3', 5555); -- udp service protected by gateway

-- d. sdpid_service - Defining access for SDP IDs
INSERT INTO sdpid_service (id, service_id, sdpid)
VALUES 
(1, 1, 2),  -- Controller accessing its own service
(2, 1, 1),  -- Gateway has access to the controller service
(3, 2, 3),  -- Client accessing TCP service
(4, 3, 3),  -- Client accessing UDP service
(5, 1, 3),
(6, 2, 1),
(7, 2, 2),
(8, 3, 1),
